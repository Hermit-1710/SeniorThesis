...
from advanced_ct_denoiser import CTNAFNet, HybridLoss, CharbonnierLoss
...
class Solver(object):
    ...
    def build_model(self, for_test=False):
        ...
        raise ValueError('Unsupported model_name: {}'.format(self.model_name))
